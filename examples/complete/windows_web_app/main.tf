...
module "windows-web-app" {
  ...
  app_settings = {
    application_insights_connection_string     = "${module.windows-web-app.connection_string}"
    application_insights_key                   = "${module.windows-web-app.instrumentation_key}"
  ...
  ##-----------------------------------------------------------------------------
  current_stack = "node" # Specify runtime stack here

  ##----------------------------------------------------------------------------- 
  ## Dot net
  ##-----------------------------------------------------------------------------
  use_dotnet          = false  # Make it true if want to use it 
  dotnet_version      = "v8.0" # For dotnet
  dotnet_core_version = "v4.0" # For dotnetcore
  ...
  docker_image_name        = var.docker_image_name # Windows based docker image should be used here
